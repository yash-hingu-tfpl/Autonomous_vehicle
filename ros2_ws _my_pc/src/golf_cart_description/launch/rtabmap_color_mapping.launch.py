...
def generate_launch_description():
    ...
    ekf_config = os.path.join('golf_cart_nav2', 'config', 'ekf.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters= ["/home/developer/ros2_ws/src/golf_cart_nav2/config/localization_config.yaml"],
            remappings=[
                ('/odometry/filtered', '/odom') # This is the final /odom for Nav2
            ]
        ),
