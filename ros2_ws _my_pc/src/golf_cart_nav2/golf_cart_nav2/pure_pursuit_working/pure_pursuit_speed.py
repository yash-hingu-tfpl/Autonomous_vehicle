...
class PurePursuitTF(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('min_speed_step', 20)
        self.declare_parameter('max_speed_step', 40)
        ...
        self.min_speed_step = self.get_parameter('min_speed_step').value
        self.max_speed_step = self.get_parameter('max_speed_step').value
    ...
    def map_speed_range(x, in_min, in_max, out_min, out_max):
         (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min

# # Example: Map 0.75 (which is halfway between 0.3 and 1.2)
# val = 0.75
# result = map_range(val, 0.3, 1.2, 20, 40)

# print(f"Mapped value: {result}") 
# # Output: 30.0 (Exactly the midpoint of 20 and 40)
    # ---------------------------------------------------
    ...
    def control_loop(self):
        ...
        self.map_speed_range(self.min_speed,self.max_speed,)
