...
class PurePursuitTF(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('lookahead_distance', 2.0) # 4.0
        self.declare_parameter('wheelbase', 2.3)
        self.declare_parameter('max_steering_angle', 0.40) # 0.5236
        ...
        self.get_logger().info('Pure Pursuit Controller (TF based) Started')
