...
class StanleyController(Node):
    ...
    def load_path(self, file_path):
        ...
        try:
            ...
            self.get_logger().info(f'K  gain : {self.get_parameter("k_gain").value}')
    ...
    def control_loop(self):
        ...
        self.get_logger().info(f'cross_track_error : {cross_track_error}')
